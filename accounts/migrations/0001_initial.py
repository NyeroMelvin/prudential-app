    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Prudential Super Admin'), ('CBHI_ADMIN', 'CBHI Admin'), ('MARKETING', 'Marketing Team'), ('APPLICANT', 'Community Member')], default='APPLICANT', max_length=20)),
